...
sprite_sheet = pg.image.load(os.path.join('System Map.png'))
...
while loop:
    ...
    # print the x, y, and zoom levels every 10 frames
    print("X: %d, Y: %d, ZOOM: %f" % (game_state.world_offset_x, game_state.world_offset_y, game_state.zoom))
